...
class FriendsManager{
    ...
    func getFriends(user_id: String, session_Token: String,fetch_type:String, completionBlock: @escaping (_ Success:FollowingModel.FollowingSuccessModel?,_ AuthError:FollowingModel.FollowingErrorModel?,_ ServerKeyError:FollowingModel.ServerKeyErrorModel?, Error?) ->()){
        ...
        AF.request(API.FRIENDS_API.GET_FRIEND_API + "\(session_Token)", method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in

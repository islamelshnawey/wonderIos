...
class FilterFriendsVC: UIViewController {
    ...
    @IBOutlet var resetFilterBtn: RoundButton!
    ...
    override func viewDidLoad() {
        ...
        self.statusOnline.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.statusOffline.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.statusAll.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.statusOnline.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.resetFilterBtn.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
        self.filterBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.silder.minimumTrackTintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
...
//            UIColor.hexStringToUIColor(hex: "984243")
             ...
             self.statusAll.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
//                UIColor.hexStringToUIColor(hex: "984243")
...
//                UIColor.hexStringToUIColor(hex: "984243")
    ...
    @IBAction func status(_ sender: UIButton) {
             if (sender.tag == 0){
                 ...
                 self.statusOnline.backgroundColor = .white
                 self.statusOffline.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
//                    UIColor.hexStringToUIColor(hex: "984243")

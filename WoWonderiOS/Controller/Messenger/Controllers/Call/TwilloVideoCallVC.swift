...
class TwilloVideoCallVC: UIViewController {
...
//    @IBOutlet weak var roomLabel: UILabel!
    ...
    @IBOutlet weak var locaVideoImage: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        self.locaVideoImage.alpha = 0
        self.muteButtonImage.alpha = 0
    }
...
extension TwilloVideoCallVC : TVIRoomDelegate {
...
extension TwilloVideoCallVC : TVIRemoteParticipantDelegate {
...
extension TwilloVideoCallVC : TVIVideoViewDelegate {
...
extension TwilloVideoCallVC : TVICameraCapturerDelegate {

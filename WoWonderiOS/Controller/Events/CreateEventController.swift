...
class CreateEventController: UIViewController,uploadImageDelegate,UITextFieldDelegate,UITextViewDelegate,getAddressDelegate{
...
//        self.present(vc, animated: true, completion: nil)
                    ...
                    if success != nil {
                        ...
                        if (self.isHome == 0){
                            ...
                            self.dismiss(animated: true) {
                                self.delgate?.loadEvent(type: "create_event")
                            }
                        }
                    }
    ...
    @IBAction func CreateEvent(_ sender: Any) {
        ...
        if (self.eventName.text?.isEmpty == true){
            ...
            ZKProgressHUD.setForegroundColor(UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor))

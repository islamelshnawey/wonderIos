...
class ApplyJobVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.nanView.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.titleLabel.text = self.titleString?.htmlToString ?? ""

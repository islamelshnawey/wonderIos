...
class DeleteGroupController: UIViewController {
    ...
    @IBAction func CheckBtn(_ sender: Any) {
        if ischeck == 0 {
            self.checkView.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
//                UIColor.hexStringToUIColor(hex: "#984243")
    ...
    @IBAction func Delete(_ sender: Any) {
        ...
        else if self.checkView.backgroundColor != UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor){

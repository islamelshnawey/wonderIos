...
//        print("settings adata = \(AppInstance.instance.siteSettings?.config?.postColors)")
    ...
    private func updatePost(postText:String,postPrivacy:Int,postColor:String){
        ...
        performUIUpdatesOnMain {
            AddPostManager.instance.addPostText( userID:userID,postText: postText, postColor: postColor, postPrivacy: postPrivacy, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location) { (success, authError, error) in
                if success != nil {
//                    print(success?.postData)
    ...
    private func uploadImages(imageArray:[Data]){
        ZKProgressHUD.show()
        AddPostManager.instance.addImages(userID : UserData.getUSER_ID() ?? "", postText: self.postText ?? "", postColor: self.PostColor ?? "", postPrivacy: self.postPrivacy ?? 0, imageDataArray: imageArray, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location) { (success, authError, error) in
            if success != nil {
                AppInstance.instance.commingBackFromAddPost = true
                var postID = ""
                if let post_data = success?.post_data["post_id"] as? String{
    ...
    private func uploadVideo(videoData:Data){
        ...
        AddPostManager.instance.addVideo(userID: UserData.getUSER_ID() ?? "", postText: self.postText ?? "", postColor: self.PostColor ?? "", postPrivacy: self.postPrivacy ?? 0, videoData: videoData, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location ) { (success, authError, error) in
            if success != nil {
                AppInstance.instance.commingBackFromAddPost = true
                var postID = ""
                if let post_data = success?.post_data["post_id"] as? String{
    ...
    private func postGIF(GIFURL:String){
        ...
        AddPostManager.instance.postGiF(userID: UserData.getUSER_ID() ?? "", postText: self.postText ?? "", postColor: self.PostColor ?? "", postPrivacy: self.postPrivacy ?? 0, GIFUrl: GIFURL, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location ) { (success, authError, error) in
            if success != nil {
                AppInstance.instance.commingBackFromAddPost = true
                ZKProgressHUD.dismiss()
                var postID = ""
    ...
    private func uploadMusic(musicData:Data){
        ...
        AddPostManager.instance.postMusic(userID: UserData.getUSER_ID() ?? "", postText: self.postText ?? "", postColor: self.PostColor ?? "", postPrivacy: self.postPrivacy ?? 0, musicData: musicData, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location ) { (success, authError, error) in
            if success != nil {
                AppInstance.instance.commingBackFromAddPost = true
                var postID = ""
                if let post_data = success?.post_data["post_id"] as? String{
    ...
    private func updateFeeling(feelingType:String,feelingName:String,postText:String,postPrivacy:Int,postColor:String){
        ...
        performUIUpdatesOnMain {
            ...
            AddPostManager.instance.addFeeling( userID:userID,postText: postText, postColor: postColor, postPrivacy: postPrivacy, feelingName: feelingName, feelingType: feelingType, pageID: self.pageid ?? "", groupID: self.groupId ?? "", eventID: self.eventId ?? "", postType:self.postType ?? "", location: self.location) { (success, authError, error) in
                if success != nil {
                    AppInstance.instance.commingBackFromAddPost = true
                      ZKProgressHUD.dismiss()
                    var postID = ""

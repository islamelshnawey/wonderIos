...
class UserDonationCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.followingLabel.borderColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.followingLabel.setTitleColor(UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor), for: .normal)
